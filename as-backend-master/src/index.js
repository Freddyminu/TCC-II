...
app.get('/search', (req, res) => {
    ...
    // my_utils.search(res, query, count, author, venue, begin_date, end_date); // MONGODB 
    my_utils.search_article_metadata(res, query, count, author, venue, begin_date, end_date); //POSTGRESQL [FRED]
});
